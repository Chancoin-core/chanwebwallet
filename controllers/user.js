...
exports.getAccount = (req, res) => {
      ...
      if(req.user.secret) {
        var qrData = sprintf('otpauth://totp/%s?secret=%s', 'Chancoin Wallet: '+req.user.email, key);
...
exports.postReset = (req, res, next) => {
  ...
  const sendResetPasswordEmail = (user) => {
    ...
    const mailOptions = {
      to: user.email,
      from: 'no-reply@chancoinwallet.io',
      subject: 'Your ChancoinWallet.io password has been changed',
...
exports.postForgot = (req, res, next) => {
  ...
  const sendForgotPasswordEmail = (user) => {
    ...
    const mailOptions = {
      to: user.email,
      from: 'no-reply@chancoinwallet.io',
      subject: 'Reset your password on ChancoinWallet.io',
